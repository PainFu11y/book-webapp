...
VALUES ('1990-05-15', 'john.doe@email.com', 'John Doe', 'pass123', '555-123-4567'),
       ...
       ('1980-04-10', 'example@email.com', 'Emily Harris', '$2a$10$0.RPT/EQkMWmSwpmkZnNfO4bdkGdOPg8k3wau7vwxMHnm4FFC.cAC', '555-098-7344');
...
VALUES (1000.00, 'client1@example.com', 'Medelyn Wright', 'password123'),
       ...
       (880.20, 'example1@email.com', 'John Doe', '$2a$10$Xom5stYY92kiLFNk1u.DaOzikYgnoTApVWd/G608PvysYouGWrBRG');
...
INSERT INTO ORDERS (PRICE, CLIENT_ID, EMPLOYEE_ID, ORDER_DATE,	ORDER_STATUS)
VALUES
    (44.98, 1, 1, '2025-11-28', 'PENDING'),
    (29.50, 1, 1, '2025-11-29', 'PENDING'),
    (34.98, 1, 1, '2025-11-30', 'PENDING');

INSERT INTO BOOK_ITEMS (BOOK_ID, ORDER_ID, QUANTITY)
VALUES
    (1, 1, 1),
    (2, 1, 1),
    (4, 3, 2);
INSERT INTO ADMINS (EMAIL, NAME, PASSWORD)
VALUES ('admin@example.com', 'Admin Name', '$2a$10$Xom5stYY92kiLFNk1u.DaOzikYgnoTApVWd/G608PvysYouGWrBRG');
